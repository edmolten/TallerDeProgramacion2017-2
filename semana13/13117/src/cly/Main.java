    ...
    */
    ...
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            String centerCords[] = reader.nextLine().split(" ");
            point center = new point(Double.valueOf(centerCords[0]), Double.valueOf(centerCords[1]));
            String[] xy;
            int x, y;
            point p = null;
            point firstP = null;
            ...
            for (int i = 0; i < N; i++) {
                ...
                if (i == 0) {
                    ...
                    point p2 = p;
                    p = new point(x, y);
                    distance = distToLineSegment(center, p, p2, minP);
                    if (distance < minDist) {
                        minDist = distance;
                    }
            ...
            distance = distToLineSegment(center, p, firstP, minP);
            if (distance < minDist) {
                minDist = distance;
            }
            NumberFormat nf = NumberFormat.getInstance();
            nf.setMaximumFractionDigits(3);
            String asd = String.format("%.3f", Double.valueOf(nf.format((minDist))));
